      ...
      <form onSubmit={handleCreatePayment} className="space-y-6">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-8 pr-4 py-3 border border-[color:var(--border)] bg-[color:var(--panel-2)] text-[color:var(--text)] rounded-xl focus:ring-2 focus:ring-[color:var(--brand-2)] focus:border-transparent text-lg"
              placeholder="0.00"
              required
              disabled={loading}
            />
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-[color:var(--border)] bg-[color:var(--panel-2)] text-[color:var(--text)] rounded-xl focus:ring-2 focus:ring-[color:var(--brand-2)] focus:border-transparent"
